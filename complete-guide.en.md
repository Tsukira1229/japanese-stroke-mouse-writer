...
English supports `A–Z` and `a–z`, numbers support `0–9`, and supported symbols are `, . ! ? : ; 、。・ー ，～@`. Other characters produce an error before writing. Light cells in the preview show placement; black lines are the actual stroke paths.
