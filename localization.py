...
ZH_HANS = {**ZH_HANT,
    ...
    "layout_right_small": "向右排版时，末端 X 必须位于起点右侧且至少容纳一个字格。", "layout_left_small": "向左排版时，起点与末端的水平范围至少需要容纳一个字格。", "layout_text_empty": "请输入至少一个支持的书写字符。",
...
JA = {**EN,
    ...
    "layout_right_small": "右方向では終了 X を開始点より右に置き、1文字分以上確保してください。", "layout_left_small": "左方向では横幅を1文字分以上確保してください。", "layout_text_empty": "対応している書き込み文字を1文字以上入力してください。",
