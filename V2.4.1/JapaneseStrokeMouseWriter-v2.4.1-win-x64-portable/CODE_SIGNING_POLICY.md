...
The project applied for the SignPath Foundation open-source code-signing program, but the application was not approved at this time. Current releases and internal builds, including V2.4.1, are unsigned.
