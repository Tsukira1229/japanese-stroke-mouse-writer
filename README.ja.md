...
1. `JapaneseStrokeMouseWriter-v2.1.2-win-x64-portable.zip` をダウンロードします。
...
- 数字：`0–9`。
- 記号：`, . ! ? : ; 、。・ー ，～@`。
- 記号は文字マス内の自然な大きさと位置を保ち、コンマや句点は下側に配置されます。
...
V2.1.2 は未署名のため、Windows SmartScreen に発行元不明の警告が表示される場合があります。
