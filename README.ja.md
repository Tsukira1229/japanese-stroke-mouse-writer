...
1. `JapaneseStrokeMouseWriter-v2.1.3-win-x64-portable.zip` をダウンロードします。
...
- 数字：`0–9`。
- 記号：`,， .． !！ ?？ :： ;； @＠ ~～ 、､ 。｡ ・･ ーｰ`。
- 半角・全角記号はいずれも1マスを使用し、同じ筆順経路と自然な配置を共有します。
...
V2.1.3 は未署名のため、Windows SmartScreen に発行元不明の警告が表示される場合があります。
