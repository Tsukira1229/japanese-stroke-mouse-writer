...
The project applied for the SignPath Foundation open-source code-signing program, but the application was not approved. Current releases, including V2.7.1, are unsigned.
