...
<head>
  ...
  <title>Japanese Stroke Mouse Writer V2.7.0 Development - {guide.title}</title>
  <style>{STYLE}</style>
</head>
<body>
  <header class="topbar">
    <a class="brand" href="#content">Japanese Stroke Mouse Writer V2.7.0 Development</a>
  ...
  <div class="layout">
    ...
    <main id="content">
      {body}
      <p class="footer">Japanese Stroke Mouse Writer V2.7.0 Development - Offline documentation</p>
    </main>
  </div>
</body>
</html>
