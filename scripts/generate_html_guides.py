...
<head>
  ...
  <title>Japanese Stroke Mouse Writer V2.6.1 - {guide.title}</title>
  <style>{STYLE}</style>
</head>
<body>
  <header class="topbar">
    <a class="brand" href="#content">Japanese Stroke Mouse Writer V2.6.1</a>
  ...
  <div class="layout">
    ...
    <main id="content">
      {body}
      <p class="footer">Japanese Stroke Mouse Writer V2.6.1 - Offline documentation</p>
    </main>
  </div>
</body>
</html>
