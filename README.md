...
1. 下載 `JapaneseStrokeMouseWriter-v2.2.0-win-x64-portable.zip`。
...
日文、英文、數字及部分符號筆順來自 [KanjiVG](https://kanjivg.tagaini.net/)（[GitHub](https://github.com/KanjiVG/kanjivg)），採 Creative Commons Attribution-ShareAlike 3.0。缺少的 ASCII 符號、`～` 與 `@` 使用本專案建立的中心線資料。詳見 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。

V2.2.0 為未簽章版本，Windows SmartScreen 可能顯示未知發行者提示。
