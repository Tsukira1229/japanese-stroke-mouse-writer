# Japanese Stroke Mouse Writer V2.2.0 Portable
...
1. Download `JapaneseStrokeMouseWriter-v2.2.0-win-x64-portable.zip`.
...
Japanese, English, number, and selected symbol stroke data comes from [KanjiVG](https://kanjivg.tagaini.net/) ([GitHub](https://github.com/KanjiVG/kanjivg)) under CC BY-SA 3.0. Missing ASCII symbols, `～`, and `@` use project-authored centerline paths. See [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).

V2.2.0 is unsigned, so Windows SmartScreen may display an unknown-publisher warning.
